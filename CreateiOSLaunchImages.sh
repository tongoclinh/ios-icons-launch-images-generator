...
# iPad @2x - landscape
sips -Z 2048 -c 1536 2048 Default-Input.png --out Images.xcassets/LaunchImage.launchimage/Default2048x1536.png
# iPad @2x - portrait
sips -Z 2048 -c 2048 1536 Default-Input.png --out Images.xcassets/LaunchImage.launchimage/Default1536x2048.png
# iPad @1x - landscape
...
# iPad @1x - portrait
sips -Z 1024 Images.xcassets/LaunchImage.launchimage/Default1536x2048.png --out Images.xcassets/LaunchImage.launchimage/Default768x1024.png
